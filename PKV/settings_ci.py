...
WEBPUSH_VAPID_SUBJECT = 'mailto:ci@example.com'
SITE_URL = 'http://localhost:8000'
PUPPETEER_HOST_URL = 'http://127.0.0.1:3010/render'
SANDBOX_DAEMON_URL = 'http://127.0.0.1:5005'
SANDBOX_DOCKER_IMAGE = 'sentinel-sandbox:latest'
SANDBOX_DOCKER_MEMORY = '1g'
SANDBOX_DOCKER_PIDS_LIMIT = 64
SANDBOX_TIMEOUT = 45
SANDBOX_DAEMON_TIMEOUT = 30
